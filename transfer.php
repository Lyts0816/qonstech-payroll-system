    ...
    // }
        ...
        if ($Employee_ID !== null && $Checkin_One !== null) {
            ...
            if ($attendance) {
                ...
                $stmt->execute([
                    ':Employee_ID' => $Employee_ID,
                    ':Checkin_One' => $isMorning ? $Checkin_One : null,
                    ':Checkin_Two' => $isAfternoon ? $Checkin_One : null
                ]);
            }
